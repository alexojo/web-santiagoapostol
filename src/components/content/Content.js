            ...
            <div className="2xl:px-20 lg:px-12 px-4 flex flex-wrap justify-center mt-4">
                ...
                <div className="mt-6 ml-6">
                    <div className="lg:flex ">
                        ...
                        <div>
                            <div className="flex ml-6">
                                ...
                                <img tabIndex={0} src="https://i.ibb.co/6PR2Y74/Rectangle-15.png" className="w-20 h-24 mt-6 lg:mt-0 rounded-lg ml-6" alt="woman" />
                            </div>
                    ...
                    <div className="mt-6 flex flex-wrap">
                        ...
                        <img tabIndex={0} className="w-72 h-56 rounded-lg mt-6 sm:mt-0   ml-6" src="https://i.ibb.co/VBcgkVL/Rectangle-11.png" alt="young girl with red hair" />
                    </div>
                </div>
            </div>
        </div>
