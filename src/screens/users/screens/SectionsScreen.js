                        ...
                        <table className="w-full whitespace-nowrap">
                            <thead>
                                <tr className="h-10 w-full text-sm leading-none text-gray-800">
                                    <th className="font-bold text-left pl-7">Grado</th>
                                    <th className="font-bold text-left pl-7">Nivel</th>
                                    <th className="font-bold text-left pl-7">Sección</th>
                                    <th className="font-bold text-left pl-7">N° Estudiantes</th>
                                    <th className="font-bold text-left pl-7">Tutor</th>
                                </tr>
                            </thead>
                ...
                <div className='overflow-auto'>
                    ...
                    <div className='px-4 mt-4 '>
                        ...
                        <div className='flex flex-col items-center mt-4'>
                            ...
                            <div className="w-28 h-28 shadow-lg bord border-[5px] border-white shadow-gray-300 bg-slate-200 rounded-full flex justify-center items-center">
                                <p className="text-4xl font-extrabold text-sky-600">1° P</p>
                            </div>
                            <p className='font-bold leading-none text-base text-sky-600 mt-4'>1° Primaria A</p>
                        ...
                        <div className='flex text-sm text-gray-800 mt-7'>
                            <div className='flex flex-col gap-3'> 
                                <div>
                                    <p className='font-bold'>Tutor</p>
                                    <p className='text-xs mt-1'>Roxana Rodriguez Villagarcia</p>
                                </div>
                            </div>
                        </div>

                        <div className='text-sm text-gray-800 mt-7'>
                            <p className='font-bold'>Estudiantes del salón</p>
