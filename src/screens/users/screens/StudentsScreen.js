    ...
    <div className='pl-60 h-screen flex overflow-auto bg-gray-100'>
        ...
        <div className='w-4/5 flex flex-col items-start'>
            ...
            <div className="w-full sm:px-6">
                ...
                <div className="bg-white shadow px-4 pt-4  pb-5 overflow-y-auto rounded-lg">
        ...
        <div className='w-1/5 bg-white mr-6 px-4 my-5 shadow rounded-lg flex flex-col justify-between'>

            <div>

                <div className=' mt-5 mb-10 h-20 py-1 shadow-2xl shadow-slate-300/70 border-[1px] border-slate-100 rounded-md '>
            ...
            <div className='mt-5 border-t-[1px] my-2 flex items-center justify-center'>   
                <button 
